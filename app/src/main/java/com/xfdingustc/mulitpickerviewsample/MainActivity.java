package com.xfdingustc.mulitpickerviewsample;
...
import com.xfdingustc.mulitpickerviewsample.bean.ProvinceBean;
import com.xfdingustc.multipickerview.MultiPickerViewOld;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //选项选择器
        pvOptions = new MultiPickerViewOld(this);
...
//        pwOptions.setLabels("省", "市", "区");
        ...
        pvOptions.setOnoptionsSelectListener(new MultiPickerViewOld.OnOptionsSelectListener() {
