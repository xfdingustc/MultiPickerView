...
import com.xfdingustc.multipickerview.view.BasePickerView;
import com.xfdingustc.multipickerview.view.WheelOptions;
 ...
 */
public class MultiPickerViewOld<T> extends BasePickerView implements View.OnClickListener {
    ...
    public MultiPickerViewOld(Context context) {
        super(context);
